...
(function (t, n) {
    ...
    function u(t, n) {
        function e(e) {
            var p = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
                d = null == u ? n.tickFormat ? n.tickFormat.apply(n, r) : Ha : u, v = Math.max(a, 0) + s, g = n.range(),
                _ = +g[0] + .5, y = +g[g.length - 1] + .5, m = (n.bandwidth ? function (t) {
                ...
                })(n.copy()), x = e.selection ? e.selection() : e, b = x.selectAll(".domain").data([null]),
                w = x.selectAll(".tick").data(p, n).order(), M = w.exit(),
                T = w.enter().append("g").attr("class", "tick"), N = w.select("line"), k = w.select("text");
        ...
        var r = [], i = null, u = null, a = 6, c = 6, s = 3, f = t === ja || t === $a ? -1 : 1,
            l = t === $a || t === Xa ? "x" : "y", h = t === ja || t === Va ? function (t) {
    ...
    function C(t, n) {
        var e = t.document.documentElement, r = vc(t).on("dragstart.drag", null);
    ...
    function W(t) {
        ...
        var e = tt(t.r), r = tt(t.g), i = tt(t.b), o = Q((.4124564 * e + .3575761 * r + .1804375 * i) / qc),
    ...
    function rt(t, n, e, r) {
        return 1 === arguments.length ? function (t) {
            ...
            t instanceof H || (t = Y(t));
            var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Zc * r + $c * n - Wc * e) / (Zc + $c - Wc), o = r - i,
                u = (Vc * (e - i) - jc * o) / Xc, a = Math.sqrt(u * u + o * o) / (Vc * i * (1 - i)),
        ...
        return function (o, u) {
            ...
            return o = t(o), u = t(u), function (t, r, i, o, u, a) {
                if (t !== i || r !== o) {
                    ...
                    a.push({i: c - 4, x: fs(t, i)}, {i: c - 2, x: fs(r, o)})
                ...
                if (t !== e || n !== r) {
                    ...
                    u.push({i: a - 4, x: fs(t, e)}, {i: a - 2, x: fs(n, r)})
    ...
    function pt(t) {
        return function (n, e) {
            var r = t((n = X(n)).h, (e = X(e)).h), i = st(n.s, e.s), o = st(n.l, e.l), u = st(n.opacity, e.opacity);
            return function (t) {
    ...
    function dt(t) {
        return function (n, e) {
            var r = t((n = nt(n)).h, (e = nt(e)).h), i = st(n.c, e.c), o = st(n.l, e.l), u = st(n.opacity, e.opacity);
            return function (t) {
    ...
    function vt(t) {
        return function n(e) {
            function r(n, r) {
                var i = t((n = rt(n)).h, (r = rt(r)).h), o = st(n.s, r.s), u = st(n.l, r.l),
    ...
    function Ut(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);) if (!(t = t.parentNode)) return Tf.time = gt(), Tf;
        return e
    }
    ...
    function jt(n) {
        ...
        function r() {
            var t = vc(this), n = Bt(this).selection;
        ...
        function u() {
            ...
            function o() {
                ...
                d < c && (N *= -1, t = a, a = p, p = t, t = c, c = d, d = t, M in Uf && I.attr("cursor", Df[M = Uf[M]])), g < h && (k *= -1, t = f, f = v, v = t, t = h, h = g, g = t, M in Of && I.attr("cursor", Df[M = Of[M]])), S.selection && (A = S.selection), x && (c = A[0][0], d = A[1][0]), b && (h = A[0][1], g = A[1][1]), A[0][0] === c && A[0][1] === h && A[1][0] === d && A[1][1] === g || (S.selection = [[c, h], [d, g]], r.call(w), O.brush())
            }
            ...
            if (l.apply(this, arguments)) {
                var a, c, f, h, p, d, v, g, _, y, m, x, b, w = this, M = t.event.target.__data__.type,
                    T = "selection" === (t.event.metaKey ? M = "overlay" : M) ? Af : t.event.altKey ? Pf : zf,
                    N = n === Lf ? null : Ff[M], k = n === Rf ? null : If[M], S = Bt(w), E = S.extent, A = S.selection,
                    z = E[0][0], P = E[0][1], R = E[1][0], L = E[1][1], q = N && k && t.event.shiftKey, D = cc(w),
                    U = D, O = i(w, arguments).beforestart();
                "overlay" === M ? S.selection = A = [[a = n === Lf ? z : D[0], f = n === Rf ? P : D[1]], [p = n === Lf ? R : a, v = n === Rf ? L : f]] : (a = A[0][0], f = A[0][1], p = A[1][0], v = A[1][1]), c = a, h = f, d = p, g = v;
                var F = vc(w).attr("pointer-events", "none"), I = F.selectAll(".overlay").attr("cursor", Df[M]);
                if (t.event.touches) F.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", u, !0); else {
        ...
        var s, f = Yt, l = It, h = a(e, "start", "brush", "end"), p = 6;
        return e.move = function (t, e) {
            t.selection ? t.on("start.brush", function () {
                ...
                var o = this, u = o.__brush, a = i(o, arguments), c = u.selection,
                    s = n.input("function" == typeof e ? e.apply(this, arguments) : e, u.extent), f = vs(c, s);
                return c && s ? t : t(1)
            }) : t.each(function () {
    ...
    function Rn(t, n) {
        n = (n *= mh) / 2 + gh;
        var e = (t *= mh) - Ul, r = e >= 0 ? 1 : -1, i = r * e, o = Mh(n), u = Eh(n), a = Fl * u,
            c = Ol * o + a * Mh(i), s = a * r * Eh(i);
    ...
    function Bn(t, n) {
        var e = qn([t * mh, n * mh]);
        if ($l) {
            var r = Un($l, e), i = Un([r[1], -r[0], 0], r);
            In(i), i = Ln(i);
            var o, u = t - jl, a = u > 0 ? 1 : -1, c = i[0] * yh * a, s = xh(u) > 180;
    ...
    function ne(t, n) {
        t *= mh;
        var e = Mh(n *= mh), r = e * Mh(t), i = e * Eh(t), o = Eh(n),
    ...
    function ue(t, n) {
        t *= mh;
        var e = Mh(n *= mh), r = e * Mh(t), i = e * Eh(t), o = Eh(n), u = fh * o - lh * i, a = lh * r - sh * o,
            c = sh * i - fh * r, s = Ch(u * u + a * a + c * c), f = Tn(s), l = s && -f / s;
    ...
    function le(t, n) {
        function e(t, n) {
            var e = Mh(n), a = Mh(t) * e, c = Eh(t) * e, s = Eh(n), f = s * r + a * i;
            return [wh(c * o - f * u, a * r - s * i), Tn(f * o + c * u)]
        }

        var r = Mh(t), i = Eh(t), o = Mh(n), u = Eh(n);
        return e.invert = function (t, n) {
            var e = Mh(n), a = Mh(t) * e, c = Eh(t) * e, s = Eh(n), f = s * o - c * u;
    ...
    function ye(t, n, e, r) {
        ...
        return function (u) {
            ...
            function s(o, u) {
                var a = i(o, u);
                if (l && h.push([o, u]), m) p = o, d = u, v = a, m = !1, a && (b.lineStart(), b.point(o, u)); else if (a && y) b.point(o, u); else {
            ...
            var f, l, h, p, d, v, g, _, y, m, x, b = u, w = np(), M = {
    ...
    function be(t, n) {
        t *= mh;
        var e = Eh(n *= mh), r = Mh(n), i = xh(t - Hh), o = Mh(i), u = r * Eh(i), a = Xh * e - jh * r * o,
            c = jh * e + Xh * r * o;
    ...
    function Ce() {
        ...
        var e, r, i, o, u, a, c, s, f, l, h, p, d = 10, v = d, g = 90, _ = 360, y = 2.5;
    ...
    function Oe(t, n) {
        var e = t - Jh, r = n - Kh, i = Ch(e * e + r * r);
    ...
    function ar(t) {
        return function (n, e) {
            var r = Ch(n * n + e * e), i = t(r), o = Eh(i), u = Mh(i);
    ...
    function sr(t) {
        function n() {
            var n = dh * a(), u = o(tp(o.rotate()).invert([0, 0]));
            return s(null == f ? [[u[0] - n, u[1] - n], [u[0] + n, u[1] + n]] : t === cr ? [[Math.max(u[0] - n, f), e], [Math.min(u[0] + n, r), i]] : [[f, Math.max(u[1] - n, e)], [r, Math.min(u[1] + n, i)]])
        }

        var e, r, i, o = er(t), u = o.center, a = o.scale, c = o.translate, s = o.clipExtent, f = null;
    ...
    function lr(t, n) {
        ...
        var r = Mh(t), i = t === n ? Eh(t) : kh(r / Mh(n)) / kh(fr(n) / fr(t)), o = r * Sh(fr(t), i) / i;
        return i ? (e.invert = function (t, n) {
            var e = o - n, r = Ah(i) * Ch(t * t + e * e);
    ...
    function pr(t, n) {
        ...
        var r = Mh(t), i = t === n ? Eh(t) : (r - Mh(n)) / (n - t), o = r / i + t;
    ...
    function Tr(t, n) {
        var e, r, i, o, u, a = new Er(t), c = +t.value && (a.value = t.value), s = [a];
        for (null == n && (n = Nr); e = s.pop();) if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length)) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new Er(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function ci() {
        ...
        var n, e, r = ai().unknown(void 0), i = r.domain, o = r.range, u = [0, 1], a = !1, c = 0, s = 0, f = .5;
    ...
    function bi() {
        ...
        var e = hi(gi, _i).domain([1, 10]), r = e.domain, i = 10, o = mi(10), u = yi(10);
    ...
    function Ri(t) {
        ...
        var i = t.dateTime, o = t.date, u = t.time, a = t.periods, c = t.days, s = t.shortDays, f = t.months,
            l = t.shortMonths, h = Di(a), p = Ui(a), d = Di(c), v = Ui(c), g = Di(s), _ = Ui(s), y = Di(f), m = Ui(f),
            x = Di(l), b = Ui(l), w = {
                a: function (t) {
                    return s[t.getDay()]
                }, A: function (t) {
                    ...
                    return f[t.getMonth()]
                }, c: null, d: ro, e: ro, f: co, H: io, I: oo, j: uo, L: ao, m: so, M: fo, p: function (t) {
                ...
                }, c: null, d: bo, e: bo, f: ko, H: wo, I: Mo, j: To, L: No, m: So, M: Eo, p: function (t) {
                ...
                a: function (t, n, e) {
                    ...
                    return r(t, i, n, e)
                }, d: $i, e: $i, f: Ki, H: Zi, I: Zi, j: Wi, L: Ji, m: Vi, M: Gi, p: function (t, n, e) {
                    var r = h.exec(n.slice(e));
                    return r ? (t.p = p[r[0].toLowerCase()], e + r[0].length) : -1
                }, Q: no, s: eo, S: Qi, u: Fi, U: Ii, V: Yi, w: Oi, W: Bi, x: function (t, n, e) {
                    return r(t, o, n, e)
                }, X: function (t, n, e) {
                    return r(t, u, n, e)
                }, y: ji, Y: Hi, Z: Xi, "%": to
    ...
    function jo(t, n, e, i, o, u, a, c, s) {
        function f(n, e, i, o) {
            if (null == n && (n = 10), "number" == typeof n) {
                var u = Math.abs(i - e) / n, a = ma(function (t) {
                    return t[2]
                }).right(w, u);
        ...
        var l = hi(fi, fs), h = l.invert, p = l.domain, d = s(".%L"), v = s(":%S"), g = s("%I:%M"), _ = s("%I %p"),
            y = s("%a %d"), m = s("%b %d"), x = s("%B"), b = s("%Y"),
            w = [[a, 1, Zv], [a, 5, 5 * Zv], [a, 15, 15 * Zv], [a, 30, 30 * Zv], [u, 1, Gv], [u, 5, 5 * Gv], [u, 15, 15 * Gv], [u, 30, 30 * Gv], [o, 1, Qv], [o, 3, 3 * Qv], [o, 6, 6 * Qv], [o, 12, 12 * Qv], [i, 1, Jv], [i, 2, 2 * Jv], [e, 1, Kv], [n, 1, tg], [n, 3, 3 * tg], [t, 1, ng]];
        return l.invert = function (t) {
            return new Date(h(t))
        }, l.domain = function (t) {
            return arguments.length ? p(Pd.call(t, Ho)) : p().map(Bo)
        }, l.ticks = function (t, n) {
            var e, r = p(), i = r[0], o = r[r.length - 1], u = o < i;
    ...
    function Ko(t, n, e, r, i, o, u) {
        var a = t - e, c = n - r, s = (u ? o : -o) / wg(a * a + c * c), f = s * c, l = -s * a, h = t + f, p = n + l,
            d = e + f, v = r + l, g = (h + d) / 2, _ = (p + v) / 2, y = d - h, m = v - p, x = y * y + m * m, b = i - o,
            w = h * v - d * p, M = (m < 0 ? -1 : 1) * wg(mg(0, b * b * x - w * w)), T = (w * m - y * M) / x,
    ...
    function lu(t, n, e, r, i) {
        var o = qg(n, e), u = qg(n, e = (e + i) / 2), a = qg(r, e), c = qg(r, i);
    ...
    function ia(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = d_._; a;) if ((r = oa(a, u) - o) > x_) a = a.L; else {
            if (!((i = o - function (t, n) {
                    var e = t.N;
                    if (e) return oa(e, n);
                    var r = t.site;
    ...
    function ca(t, n) {
        ...
        for (__ = [], v_ = new Array(t.length), d_ = new Iu, g_ = new Iu; ;) if (i = p_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (ia(o), e = o[0], r = o[1]), o = t.pop(); else {
            if (!i) break;
            ra(i.arc)
        }
        if (function () {
            ...
            (function (t, n, e, r) {
                ...
                var i, o, u, a, c, s, f, l, h, p, d, v, g = v_.length, _ = !0;
    ...
    var ya = function (t, n) {
    ...
    }, xa = ma(ya), ba = xa.right, wa = xa.left, Ma = function (t) {
        return null === t ? NaN : +t
    }, Ta = function (t, n) {
        var e, r, i = t.length, o = 0, u = -1, a = 0, c = 0;
        if (null == n) for (; ++u < i;) isNaN(e = Ma(t[u])) || (c += (r = e - a) * (e - (a += r / ++o))); else for (; ++u < i;) isNaN(e = Ma(n(t[u], u, t))) || (c += (r = e - a) * (e - (a += r / ++o)));
        if (o > 1) return c / (o - 1)
    }, Na = function (t, n) {
        var e = Ta(t, n);
        ...
        return [r, i]
    }, Sa = Array.prototype, Ea = Sa.slice, Aa = Sa.map, Ca = function (t) {
        return function () {
            return t
        }
    }, za = function (t) {
        ...
        return o
    }, Ra = Math.sqrt(50), La = Math.sqrt(10), qa = Math.sqrt(2), Da = function (t, n, r) {
        var i, o, u, a, c = -1;
        ...
        return r
    }, Ba = Array.prototype.slice, Ha = function (t) {
        return t
    }, ja = 1, Xa = 2, Va = 3, $a = 4, Wa = 1e-6, Za = {
        value: function () {
        }
    };
    c.prototype = a.prototype = {
        constructor: c, on: function (t, n) {
    ...
    var Ga = "http://www.w3.org/1999/xhtml", Qa = {
    ...
    S.prototype = E.prototype = {
        constructor: S, select: function (t) {
            ...
            }, r = this._parents, i = this._groups;
            ...
            for (var o = i.length, u = new Array(o), a = new Array(o), c = new Array(o), s = 0; s < o; ++s) {
                var f = r[s], l = i[s], h = l.length, p = t.call(f, f && f.__data__, s, r), d = p.length,
                    g = a[s] = new Array(d), _ = u[s] = new Array(d);
            ...
            var e = "function" == typeof t ? t : Ka(t), r = null == n ? function () {
                return null
    ...
    var vc = function (t) {
        ...
        var n = t.document.documentElement, e = vc(t).on("dragstart.drag", _c, !0);
    ...
    var xc = function (t, n, e) {
        ...
        }, bc = "\\s*([+-]?\\d+)\\s*", wc = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*",
        Mc = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Tc = /^#([0-9a-f]{3})$/, Nc = /^#([0-9a-f]{6})$/,
        kc = new RegExp("^rgb\\(" + [bc, bc, bc] + "\\)$"), Sc = new RegExp("^rgb\\(" + [Mc, Mc, Mc] + "\\)$"),
        Ec = new RegExp("^rgba\\(" + [bc, bc, bc, wc] + "\\)$"),
        Ac = new RegExp("^rgba\\(" + [Mc, Mc, Mc, wc] + "\\)$"), Cc = new RegExp("^hsl\\(" + [wc, Mc, Mc] + "\\)$"),
        zc = new RegExp("^hsla\\(" + [wc, Mc, Mc, wc] + "\\)$"), Pc = {
            aliceblue: 15792383,
    ...
    var Rc = Math.PI / 180, Lc = 180 / Math.PI, qc = .95047, Dc = 1, Uc = 1.08883, Oc = 4 / 29, Fc = 6 / 29,
        Ic = 3 * Fc * Fc, Yc = Fc * Fc * Fc;
    xc(G, Z, D(U, {
        brighter: function (t) {
    ...
    var Bc = -.14861, Hc = 1.78277, jc = -.29227, Xc = -.90649, Vc = 1.97294, $c = Vc * Xc, Wc = Vc * Hc,
        Zc = Hc * jc - Xc * Bc;
    xc(it, rt, D(U, {
        brighter: function (t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Rc, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
    ...
    var Gc, Qc, Jc, Kc, ts, ns, es = function (t) {
            ...
            function e(t, n) {
                var e = r((t = B(t)).r, (n = B(n)).r), i = r(t.g, n.g), o = r(t.b, n.b), u = st(t.opacity, n.opacity);
                return function (n) {
            ...
            var r = ct(n);
            return e.gamma = t, e
        }(1), us = ft(es), as = ft(rs), cs = function (t, n) {
        ...
        }, hs = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, ps = new RegExp(hs.source, "g"), ds = function (t, n) {
            var e, r, i, o = hs.lastIndex = ps.lastIndex = 0, u = -1, a = [], c = [];
            for (t += "", n += ""; (e = hs.exec(t)) && (r = ps.exec(n));) (i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: fs(e, r)
            })), o = ps.lastIndex;
        ...
        }, _s = 180 / Math.PI, ys = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1},
        ms = function (t, n, e, r, i, o) {
            ...
            if (h < 1e-12) r = Math.log(s / u) / ws, e = function (t) {
                ...
                var p = Math.sqrt(h), d = (s * s - u * u + 4 * h) / (2 * u * 2 * p),
                    v = (s * s - u * u - 4 * h) / (2 * s * 2 * p), g = Math.log(Math.sqrt(d * d + 1) - d),
                    _ = Math.log(Math.sqrt(v * v + 1) - v);
                r = (_ - g) / ws, e = function (t) {
                    var n = t * r, e = ht(g), a = u / (2 * p) * (e * function (t) {
        ...
        }, Ts = pt(at), Ns = pt(st), ks = dt(at), Ss = dt(st), Es = vt(at), As = vt(st), Cs = 0, zs = 0, Ps = 0, Rs = 1e3,
        Ls = 0, qs = 0, Ds = 0, Us = "object" == typeof performance && performance.now ? performance : Date,
    ...
    yt.prototype = mt.prototype = {
        constructor: yt, restart: function (t, n, e) {
    ...
    var Fs = function (t, n, e) {
        ...
        }, Is = a("start", "end", "interrupt"), Ys = [], Bs = 0, Hs = 1, js = 2, Xs = 3, Vs = 4, $s = 5, Ws = 6,
        ...
        }, Js = E.prototype.constructor, Ks = 0, tf = E.prototype;
    Et.prototype = At.prototype = {
        ...
        transition: function () {
            for (var t = this._name, n = this._id, e = Ct(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) if (u = a[s]) {
                var f = kt(u, n);
                Zs(u, t, e, s, a, {time: f.time + f.delay + f.duration, delay: 0, duration: f.duration, ease: f.ease})
            }
        ...
        attr: function (t, n) {
            var e = Ja(t), r = "transform" === e ? bs : Qs;
        ...
        style: function (t, n, e) {
            ...
            return null == n ? this.styleTween(t, function (t, n) {
                var e, r, i;
                return function () {
                    var o = _(this, t), u = (this.style.removeProperty(t), _(this, t));
    ...
    var nf = function t(n) {
            ...
            return n = +n, e.exponent = t, e
        }(3), of = Math.PI, uf = of / 2, af = 4 / 11, cf = 6 / 11, sf = 8 / 11, ff = .75, lf = 9 / 11, hf = 10 / 11,
        pf = .9375, df = 21 / 22, vf = 63 / 64, gf = 1 / af / af, _f = function t(n) {
            function e(t) {
                return t * t * ((n + 1) * t - n)
            }
        ...
        }(1, .3), Tf = {time: null, delay: 0, duration: 250, ease: Pt};
    ...
    var Nf = [null], kf = function (t) {
            ...
            t.event.preventDefault(), t.event.stopImmediatePropagation()
        }, Af = {name: "drag"}, Cf = {name: "space"}, zf = {name: "handle"}, Pf = {name: "center"}, Rf = {
            name: "x", handles: ["e", "w"].map(Ft), input: function (t, n) {
                return t && [[t[0], n[0][1]], [t[1], n[1][1]]]
            }, output: function (t) {
                return t && [t[0][0], t[1][0]]
            }
        }, Lf = {
            name: "y", handles: ["n", "s"].map(Ft), input: function (t, n) {
                return t && [[n[0][0], t[0]], [n[1][0], t[1]]]
            }, output: function (t) {
                return t && [t[0][1], t[1][1]]
            }
        }, qf = {
            name: "xy", handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(Ft), input: function (t) {
                return t
            }, output: function (t) {
                return t
            }
        ...
        If = {overlay: 1, selection: 1, n: -1, e: null, s: 1, w: null, nw: -1, ne: -1, se: 1, sw: 1}, Yf = Math.cos,
        Bf = Math.sin, Hf = Math.PI, jf = Hf / 2, Xf = 2 * Hf, Vf = Math.max, $f = Array.prototype.slice,
        Wf = function (t) {
            return function () {
                return t
            }
        }, Zf = Math.PI, Gf = 2 * Zf, Qf = Gf - 1e-6;
    Xt.prototype = Vt.prototype = {
        constructor: Xt, moveTo: function (t, n) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n); else if (l > 1e-6) if (Math.abs(f * a - c * s) > 1e-6 && i) {
                var h = e - o, p = r - u, d = a * a + c * c, v = h * h + p * p, g = Math.sqrt(d), _ = Math.sqrt(l),
                    y = i * Math.tan((Zf - Math.acos((d + l - v) / (2 * g * _))) / 2), m = y / _, x = y / g;
    ...
    on.prototype = un.prototype = {
        constructor: on, has: Jf.has, add: function (t) {
            return t += "", this["$" + t] = t, this
        }, remove: Jf.remove, clear: Jf.clear, values: Jf.keys, size: Jf.size, empty: Jf.empty, each: Jf.each
    };
    var Kf = {}, tl = {}, nl = 34, el = 10, rl = 13, il = function (t) {
            function n(t, n) {
                function e() {
                    if (s) return tl;
                    if (f) return f = !1, Kf;
                    ...
                    for (; a < u;) {
                        if ((e = t.charCodeAt(n = a++)) === el) f = !0; else if (e === rl) f = !0, t.charCodeAt(a) === el && ++a; else if (e !== o) continue;
                        return t.slice(r, n)
                    }
        ...
        }, ol = il(","), ul = ol.parse, al = ol.parseRows, cl = ol.format, sl = ol.formatRows, fl = il("\t"), ll = fl.parse,
        hl = fl.parseRows, pl = fl.format, dl = fl.formatRows, vl = function (t) {
            return function () {
                return t
            }
        }, gl = function () {
    ...
    yl.copy = function () {
        var t, n, e = new fn(this._x, this._y, this._x0, this._y0, this._x1, this._y1), r = this._root;
        if (!r) return e;
    ...
    var ml, xl = 10, bl = Math.PI * (3 - Math.sqrt(5)), wl = function (t, n) {
        ...
        "": function (t, n) {
            ...
            var e = wl(t, n);
            if (!e) return t + "";
            var r = e[0], i = e[1], o = i - (ml = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, u = r.length;
    ...
    var Sl, El = function (t) {
        return t
    }, Al = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"], Cl = function (t) {
        function n(t) {
            function n(t) {
                var n, r, u, f = g, x = _;
            ...
            var a = (t = yn(t)).fill, c = t.align, s = t.sign, f = t.symbol, l = t.zero, h = t.width, p = t.comma,
                d = t.precision, v = t.type,
                g = "$" === f ? r[0] : "#" === f && /[boxX]/.test(v) ? "0" + v.toLowerCase() : "",
                _ = "$" === f ? r[1] : /[%p]/.test(v) ? u : "", y = Nl[v], m = !v || /[defgprs%]/.test(v);
        ...
        }(t.grouping, t.thousands) : El, r = t.currency, i = t.decimal, o = t.numerals ? function (t) {
            return function (n) {
                return n.replace(/[0-9]/g, function (n) {
                    return t[+n]
                })
            }
        }(t.numerals) : El, u = t.percent || "%";
        return {
            format: n, formatPrefix: function (t, e) {
                var r = n((t = yn(t), t.type = "f", t)), i = 3 * Math.max(-8, Math.min(8, Math.floor(Ml(e) / 3))),
                    o = Math.pow(10, -i), u = Al[8 + i / 3];
                return function (t) {
                    return r(o * t) + u
                }
            }
    ...
    xn({decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""]});
    var zl = function (t) {
    ...
    var ql, Dl, Ul, Ol, Fl, Il, Yl, Bl, Hl, jl, Xl, Vl, $l, Wl, Zl, Gl, Ql, Jl, Kl, th, nh, eh, rh, ih, oh, uh, ah, ch,
        sh, fh, lh, hh = new bn, ph = 1e-6, dh = Math.PI, vh = dh / 2, gh = dh / 4, _h = 2 * dh, yh = 180 / dh,
        mh = dh / 180, xh = Math.abs, bh = Math.atan, wh = Math.atan2, Mh = Math.cos, Th = Math.ceil, Nh = Math.exp,
        kh = Math.log, Sh = Math.pow, Eh = Math.sin, Ah = Math.sign || function (t) {
            return t > 0 ? 1 : t < 0 ? -1 : 0
        }, Ch = Math.sqrt, zh = Math.tan, Ph = {
            ...
            point: kn, lineStart: kn, lineEnd: kn, polygonStart: function () {
            ...
            point: Yn, lineStart: Hn, lineEnd: jn, polygonStart: function () {
            ...
            sphere: kn, point: Qn, lineStart: Kn, lineEnd: ee, polygonStart: function () {
    ...
    var Hh, jh, Xh, Vh, $h, Wh, Zh, Gh, Qh, Jh, Kh, tp = function (t) {
    ...
    }, ip = Ll(), op = function (t, n) {
        var e = n[0], r = n[1], i = [Eh(e), -Mh(e), 0], o = 0, u = 0;
        ip.reset();
        for (var a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + gh, d = Eh(p), v = Mh(p), g = 0; g < f; ++g, h = y, d = x, v = b, l = _) {
            var _ = s[g], y = _[0], m = _[1] / 2 + gh, x = Eh(m), b = Mh(m), w = y - h, M = w >= 0 ? 1 : -1, T = M * w,
                N = T > dh, k = d * x;
        ...
        return function (i) {
            ...
            function l() {
                ...
                var t, n, e, r, o = _.clean(), u = g.result(), a = u.length;
            ...
            var h, p, d, v = n(i), g = np(), _ = n(g), y = !1, m = {
        ...
        var i;
        if (null == t) i = e * vh, r.point(-dh, i), r.point(0, i), r.point(dh, i), r.point(dh, 0), r.point(dh, -i), r.point(0, -i), r.point(-dh, -i), r.point(-dh, 0), r.point(-dh, i); else if (xh(t[0] - n[0]) > ph) {
            var o = t[0] < n[0] ? dh : -dh;
        ...
        function e(t, n, e) {
            var r = [1, 0, 0], o = Un(qn(t), qn(n)), u = Dn(o, o), a = o[0], c = u - a * a;
            if (!c) return !e && t;
            var s = i * u / c, f = -i * a / c, l = Un(r, o), h = Fn(r, s);
            On(h, Fn(o, f));
            var p = l, d = Dn(h, p), v = Dn(p, p), g = d * d - v * (Dn(h, h) - 1);
            if (!(g < 0)) {
                var _ = Ch(g), y = Fn(p, (-d - _) / v);
                if (On(y, h), y = Ln(y), !e) return y;
                var m, x = t[0], b = n[0], w = t[1], M = n[1];
                b < x && (m = x, x = b, b = m);
                var T = b - x, N = xh(T - dh) < ph;
        ...
        var i = Mh(t), o = 6 * mh, u = i > 0, a = xh(i) > ph;
        return up(n, function (t) {
            ...
            return {
                lineStart: function () {
                    ...
                    var p, d = [l, h], v = n(l, h), g = u ? v ? 0 : r(l, h) : v ? r(l + (l < 0 ? dh : -dh), h) : 0;
                    if (!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || ep(i, p) || ep(d, p)) && (d[0] += ph, d[1] += ph, v = n(d[0], d[1])), v !== c) f = 0, v ? (t.lineStart(), p = e(d, i), t.point(p[0], p[1])) : (p = e(i, d), t.point(p[0], p[1]), t.lineEnd()), i = p; else if (a && i && u ^ v) {
                        var _;
    ...
    }, fp = 1e9, lp = -fp, hp = Ll(), pp = {
        sphere: kn, point: kn, lineStart: function () {
            pp.point = xe, pp.lineEnd = me
        }, lineEnd: kn, polygonStart: kn, polygonEnd: kn
    }, dp = function (t) {
        return hp.reset(), Lh(t, pp), +hp
    }, vp = [null, null], gp = {type: "LineString", coordinates: vp}, _p = function (t, n) {
    ...
    }, Tp = 1 / 0, Np = Tp, kp = -Tp, Sp = kp, Ep = {
        point: function (t, n) {
            t < Tp && (Tp = t), t > kp && (kp = t), n < Np && (Np = n), n > Sp && (Sp = n)
        }, lineStart: kn, lineEnd: kn, polygonStart: kn, polygonEnd: kn, result: function () {
            var t = [[Tp, Np], [kp, Sp]];
            return kp = Sp = -(Np = Tp = 1 / 0), t
        }
    }, Ap = 0, Cp = 0, zp = 0, Pp = 0, Rp = 0, Lp = 0, qp = 0, Dp = 0, Up = 0, Op = {
        point: qe, lineStart: De, lineEnd: Fe, polygonStart: function () {
    ...
    var Fp, Ip, Yp, Bp, Hp, jp = Ll(), Xp = {
        point: kn, lineStart: function () {
            Xp.point = Xe
        }, lineEnd: function () {
    ...
    $e.prototype = {
        _radius: 4.5, _circle: We(4.5), pointRadius: function (t) {
    ...
    Ge.prototype = {
        constructor: Ge, point: function (t, n) {
    ...
    var Vp = 16, $p = Mh(30 * mh), Wp = function (t, n) {
        return +n ? function (t, n) {
            function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
                var _ = s - r, y = f - i, m = _ * _ + y * y;
                if (m > 4 * n && v--) {
                    var x = u + h, b = a + p, w = c + d, M = Ch(x * x + b * b + w * w), T = Tn(w /= M),
                        N = xh(xh(w) - 1) < ph || xh(o - l) < ph ? (o + l) / 2 : wh(b, x), k = t(N, T), S = k[0],
    ...
    var td = Array.prototype.slice, nd = function (t) {
        for (var n, e, r = 0, i = (t = function (t) {
            ...
            var e, r;
            if (zr(n, t)) return [n];
            for (e = 0; e < t.length; ++e) if (Ar(n, t[e]) && zr(Pr(t[e], n), t)) return [t[e], n];
            for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (Ar(Pr(t[e], t[r]), n) && Ar(Pr(t[e], n), t[r]) && Ar(Pr(t[r], n), t[e]) && zr(Rr(t[e], t[r], n), t)) return [t[e], t[r], n];
            throw new Error
        }(o, n)), r = 0);
        return e
    }, ed = function (t) {
    ...
    }, sd = (1 + Math.sqrt(5)) / 2, fd = function t(n) {
    ...
    }(sd), hd = function (t, n, e) {
        return (n[0] - t[0]) * (e[1] - t[1]) - (n[1] - t[1]) * (e[0] - t[0])
    }, pd = [].slice, dd = {};
    ei.prototype = ui.prototype = {
        constructor: ei, defer: function (t) {
    ...
    var vd = function () {
            ...
            var r, i, o, u, c = a("beforesend", "progress", "load", "error"), s = Kt(), f = new XMLHttpRequest, l = null,
                h = null, p = 0;
        ...
        }, Ad = Ed("text/csv", ul), Cd = Ed("text/tab-separated-values", ll), zd = Array.prototype, Pd = zd.map,
        Rd = zd.slice, Ld = {name: "implicit"}, qd = function (t) {
            return function () {
                return t
            }
        }, Dd = function (t) {
            return +t
        }, Ud = [0, 1], Od = function (n, e, i) {
        ...
        }, Id = new Date, Yd = new Date, Bd = Si(function () {
        }, function (t, n) {
            t.setTime(+t + n)
        }, function (t, n) {
            return n - t
    ...
    var Hd = Bd.range, jd = 6e4, Xd = 6048e5, Vd = Si(function (t) {
            ...
            return t.getDate() - 1
        }), Kd = Jd.range, tv = Ei(0), nv = Ei(1), ev = Ei(2), rv = Ei(3), iv = Ei(4), ov = Ei(5), uv = Ei(6),
        av = tv.range, cv = nv.range, sv = ev.range, fv = rv.range, lv = iv.range, hv = ov.range, pv = uv.range,
        dv = Si(function (t) {
    ...
    var _v = gv.range, yv = Si(function (t) {
            t.setUTCSeconds(0, 0)
        }, function (t, n) {
            t.setTime(+t + n * jd)
        }, function (t, n) {
        ...
        }), Mv = wv.range, Tv = Ai(0), Nv = Ai(1), kv = Ai(2), Sv = Ai(3), Ev = Ai(4), Av = Ai(5), Cv = Ai(6),
        zv = Tv.range, Pv = Nv.range, Rv = kv.range, Lv = Sv.range, qv = Ev.range, Dv = Av.range, Uv = Cv.range,
        Ov = Si(function (t) {
    ...
    var Yv, Bv = Iv.range, Hv = {"-": "", _: " ", 0: "0"}, jv = /^\s*\d+/, Xv = /^%/, Vv = /[\\^$*+?|[\]().{}]/g;
    Yo({
        dateTime: "%x, %X",
        date: "%-m/%-d/%Y",
        time: "%-I:%M:%S %p",
    ...
    var $v = Date.prototype.toISOString ? function (t) {
        ...
        } : t.utcFormat("%Y-%m-%dT%H:%M:%S.%LZ"), Wv = +new Date("2000-01-01T00:00:00.000Z") ? function (t) {
            var n = new Date(t);
            return isNaN(n) ? null : n
        } : t.utcParse("%Y-%m-%dT%H:%M:%S.%LZ"), Zv = 1e3, Gv = 60 * Zv, Qv = 60 * Gv, Jv = 24 * Qv, Kv = 7 * Jv,
        tg = 30 * Jv, ng = 365 * Jv, eg = function (t) {
        ...
        ag = As(rt(300, .5, 0), rt(-240, .5, 1)), cg = As(rt(-100, .75, .35), rt(80, 1.5, .8)),
        sg = As(rt(260, .75, .35), rt(80, 1.5, .8)), fg = rt(),
        ...
        }, gg = Math.abs, _g = Math.atan2, yg = Math.cos, mg = Math.max, xg = Math.min, bg = Math.sin, wg = Math.sqrt,
        Mg = 1e-12, Tg = Math.PI, Ng = Tg / 2, kg = 2 * Tg;
    tu.prototype = {
        areaStart: function () {
            this._line = 0
        }, areaEnd: function () {
    ...
    var Sg = function (t) {
        ...
        var n = nu, e = eu, r = vg(!0), i = null, o = Sg, u = null;
        ...
        var e = nu, r = null, i = vg(0), o = eu, u = vg(!0), a = null, c = Sg, s = null;
    ...
    var Rg = function () {
        ...
        var t = Ag().curve(Pg), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    }, Fg = Math.sqrt(1 / 3), Ig = 2 * Fg, Yg = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Ig), r = e * Fg;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, Bg = Math.sin(Tg / 10) / Math.sin(7 * Tg / 10), Hg = Math.sin(kg / 10) * Bg, jg = -Math.cos(kg / 10) * Bg, Xg = {
        draw: function (t, n) {
            var e = Math.sqrt(.8908130915292852 * n), r = Hg * e, i = jg * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var u = kg * o / 5, a = Math.cos(u), c = Math.sin(u);
    ...
    }, Zg = -.5, Gg = Math.sqrt(3) / 2, Qg = 1 / Math.sqrt(12), Jg = 3 * (Qg / 2 + 1), Kg = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Jg), r = e / 2, i = e * Qg, o = r, u = e * Qg + e, a = -o, c = u;
    ...
    }, t_ = [Ug, Og, Yg, Vg, Xg, Wg, Kg], n_ = function () {
    };
    pu.prototype = {
        areaStart: function () {
            this._line = 0
    ...
    Cu.prototype = {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = Lu(t), i = Lu(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
    ...
    Iu.prototype = {
        constructor: Iu, insert: function (t, n) {
            var e, r, i;
            if (t) {
            ...
            if (e = o ? u ? ju(u) : o : u, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && u ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== u ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = u, u.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1; else {
                do {
                    if (t === this._) break;
                    if (t === i.L) {
    ...
    var p_, d_, v_, g_, __, y_ = [], m_ = [], x_ = 1e-6, b_ = 1e-12;
    ca.prototype = {
        constructor: ca, polygons: function () {
            var t = this.edges;
            ...
            return this.cells.forEach(function (e, r) {
                if (o = (i = e.halfedges).length) for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o;) u = f, f = (s = n[i[c]]).left === a ? s.right : s.left, u && f && r < u.index && r < f.index && ua(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }), t
        }, links: function () {
    ...
    sa.prototype = {
        constructor: sa, scale: function (t) {
    ...
    t.version = "4.12.0", t.bisect = ba, t.bisectRight = ba, t.bisectLeft = wa, t.ascending = ya, t.bisector = ma, t.cross = function (t, e, r) {
        var i, o, u, a, c = t.length, s = e.length, f = new Array(c * s);
        ...
        function t(t) {
            ...
            var s = e(c), f = s[0], l = s[1], h = i(c, f, l);
        ...
        if (null == n) for (; ++o < r;) isNaN(e = Ma(t[o])) ? --i : u += e; else for (; ++o < r;) isNaN(e = Ma(n(t[o], o, t))) ? --i : u += e;
        if (i) return u / i
    }, t.median = function (t, n) {
        var e, r = t.length, i = -1, o = [];
        if (null == n) for (; ++i < r;) isNaN(e = Ma(t[i])) || o.push(e); else for (; ++i < r;) isNaN(e = Ma(n(t[i], i, t))) || o.push(e);
        ...
        function t(t) {
            var o, u, a, c, s, f, l = t.length, h = [], p = Pa(l), d = [], v = [], g = v.groups = new Array(l),
                _ = new Array(l * l);
            for (o = 0, s = -1; ++s < l;) {
            ...
            for (e && p.sort(function (t, n) {
                ...
                for (a = u, f = -1; ++f < l;) {
                    ...
                    _[m * l + y] = {index: y, subindex: m, startAngle: b, endAngle: w, value: x}
                }
                g[y] = {index: y, startAngle: a, endAngle: u, value: h[y]}, u += c
            }
            for (s = -1; ++s < l;) for (f = s - 1; ++f < l;) {
                var M = _[f * l + s], T = _[s * l + f];
        ...
        function t() {
            var t, a = $f.call(arguments), c = n.apply(this, a), s = e.apply(this, a),
                f = +r.apply(this, (a[0] = c, a)), l = i.apply(this, a) - jf, h = o.apply(this, a) - jf, p = f * Yf(l),
                d = f * Bf(l), v = +r.apply(this, (a[0] = s, a)), g = i.apply(this, a) - jf, _ = o.apply(this, a) - jf;
        ...
        var n = $t, e = Wt, r = Zt, i = Gt, o = Qt, u = null;
        ...
        function r() {
            if (_c(), !h) {
                var n = t.event.clientX - f, e = t.event.clientY - l;
                h = n * n + e * e > w
            }
            m.mouse("drag")
        }
        ...
        function o() {
            if (v.apply(this, arguments)) {
                var n, e, r = t.event.changedTouches, i = g.apply(this, arguments), o = r.length;
        ...
        var f, l, h, p, v = P, g = R, _ = L, y = q, m = {}, x = a("start", "drag", "end"), b = 0, w = 0;
        ...
        function n() {
            for (var t, n, r, c, s, f, l, h = i.length, p = 0; p < a; ++p) for (n = sn(i, hn, pn).visitAfter(e), t = 0; t < h; ++t) r = i[t], f = o[r.index], l = f * f, c = r.x + r.vx, s = r.y + r.vy, n.visit(function (t, n, e, i, o) {
        ...
        function n(n) {
            for (var e = 0, r = t.length; e < p; ++e) for (var i, a, c, f, l, h, d, v = 0; v < r; ++v) a = (i = t[v]).source, f = (c = i.target).x + c.vx - a.x - a.vx || gl(), l = c.y + c.vy - a.y - a.vy || gl(), f *= h = ((h = Math.sqrt(f * f + l * l)) - u[v]) / h * n * o[v], l *= h, c.vx -= f * (d = s[v]), c.vy -= l * d, a.vx += f * (d = 1 - d), a.vy += l * d
        }

        function e() {
            if (a) {
                var n, e, l = a.length, h = t.length, p = Kt(a, f);
        ...
        var o, u, a, c, s, f = dn, l = function (t) {
        ...
        var o, u = 1, c = .001, s = 1 - Math.pow(c, 1 / 300), f = 0, l = .6, h = Kt(), p = mt(n), d = a("tick", "end");
        return null == t && (t = []), r(), o = {
        ...
        var n = ih, e = oh, r = uh, i = n * n + e * e + r * r;
        return i < 1e-12 && (n = nh, e = eh, r = rh, Ql < ph && (n = Jl, e = Kl, r = th), (i = n * n + e * e + r * r) < 1e-12) ? [NaN, NaN] : [wh(e, n) * yh, Tn(r / Ch(i)) * yh]
    },t.geoCircle = function () {
        function t() {
            var t = r.apply(this, arguments), a = i.apply(this, arguments) * mh, c = o.apply(this, arguments) * mh;
        ...
        var n, e, r = Yh([0, 0]), i = Yh(90), o = Yh(6), u = {
            point: function (t, r) {
        ...
        var e = t[0] * mh, r = t[1] * mh, i = n[0] * mh, o = n[1] * mh, u = Mh(r), a = Eh(r), c = Mh(o), s = Eh(o),
            f = u * Mh(e), l = u * Eh(e), h = c * Mh(i), p = c * Eh(i), d = 2 * Tn(Ch(Nn(o - r) + u * c * Nn(i - e))),
            v = Eh(d), g = d ? function (t) {
                var n = Eh(t *= d) / v, e = Eh(d - t) / v, r = e * f + n * h, i = e * l + n * p, o = e * a + n * s;
        ...
        var e, r, i, o, u, a, c = Qp(), s = Gp().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            f = Gp().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
                point: function (t, n) {
                    a = [t, n]
                }
            };
        return t.invert = function (t) {
            ...
            return i = c.translate(t).clipExtent([[r - .455 * e, a - .238 * e], [r + .455 * e, a + .238 * e]]).stream(l), o = s.translate([r - .307 * e, a + .201 * e]).clipExtent([[r - .425 * e + ph, a + .12 * e + ph], [r - .214 * e - ph, a + .234 * e - ph]]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([[r - .214 * e + ph, a + .166 * e + ph], [r - .115 * e - ph, a + .234 * e - ph]]).stream(l), n()
        ...
        var n, e, r, i, o, u, a = 1, c = 0, s = 0, f = 1, l = 1, h = xp, p = null, d = xp;
        return u = {
            stream: function (t) {
        ...
        var t = sr(mr), n = t.center, e = t.rotate;
        ...
        function t(t) {
            var c = function (t) {
                for (var n, e, r, i, o, u = new Jr(t, 0), a = [u]; n = a.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new Jr(r[i], i)), e.parent = n;
        ...
        var e = fd, r = !1, i = 1, o = 1, u = [0], a = Ir, c = Ir, s = Ir, f = Ir, l = Ir;
        return t.round = function (n) {
            return arguments.length ? (r = !!n, t) : r
        }, t.size = function (n) {
        ...
        var e = st((t = Z(t)).l, (n = Z(n)).l), r = st(t.a, n.a), i = st(t.b, n.b), o = st(t.opacity, n.opacity);
        return function (n) {
        ...
        var o = ni(r), u = ni(i), a = u[0] === o[0], c = u[u.length - 1] === o[o.length - 1], s = [];
        ...
        function t() {
            var t, s, f = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - Ng,
                p = u.apply(this, arguments) - Ng, d = gg(p - h), v = p > h;
            if (c || (c = t = Vt()), l < f && (s = l, l = f, f = s), l > Mg) if (d > kg - Mg) c.moveTo(l * yg(h), l * bg(h)), c.arc(0, 0, l, h, p, !v), f > Mg && (c.moveTo(f * yg(p), f * bg(p)), c.arc(0, 0, f, p, h, v)); else {
                var g, _, y = h, m = p, x = h, b = p, w = d, M = d, T = a.apply(this, arguments) / 2,
                    N = T > Mg && (i ? +i.apply(this, arguments) : wg(f * f + l * l)),
                    k = xg(gg(l - f) / 2, +r.apply(this, arguments)), S = k, E = k;
                if (N > Mg) {
                    var A = $o(N / f * bg(T)), C = $o(N / l * bg(T));
                    (w -= 2 * A) > Mg ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2), (M -= 2 * C) > Mg ? (C *= v ? 1 : -1, y += C, m -= C) : (M = 0, y = m = (h + p) / 2)
                }
                var z = l * yg(y), P = l * bg(y), R = f * yg(b), L = f * bg(b);
                if (k > Mg) {
                    var q = l * yg(m), D = l * bg(m), U = f * yg(x), O = f * bg(x);
                    if (d < Tg) {
                        var F = w > Mg ? function (t, n, e, r, i, o, u, a) {
                                var c = U - z, s = O - P, f = u - q, l = a - D,
                                    h = (f * (P - D) - l * (z - q)) / (l * c - f * s);
                                return [z + h * c, P + h * s]
                            }(0, 0, 0, 0, 0, 0, R, L) : [R, L], I = z - F[0], Y = P - F[1], B = q - F[0], H = D - F[1],
                            j = 1 / bg(function (t) {
        ...
        var n = Wo, e = Zo, r = vg(0), i = null, o = Go, u = Qo, a = Jo, c = null;
        ...
        var n = zg, e = Cg, r = null, i = vg(0), o = vg(kg), u = vg(0);
        return t.value = function (e) {
            return arguments.length ? (n = "function" == typeof e ? e : vg(+e), t) : n
        ...
        var n, e, r = t.length, i = t.map(Uu), o = f_(t).sort(function (t, n) {
            return i[n] - i[t]
        }), u = 0, a = 0, c = [], s = [];
        ...
        function o(t, n, e) {
            t.on("start.zoom", function () {
                ...
                var t = arguments, r = u(this, t), o = m.apply(this, t), a = e || i(o),
        ...
        function s() {
            if (y.apply(this, arguments)) {
                var t = u(this, arguments), n = this.__zoom,
                    i = Math.max(M[0], Math.min(M[1], n.k * Math.pow(2, b.apply(this, arguments)))), o = cc(this);
        ...
        function f() {
            if (!_ && y.apply(this, arguments)) {
                var n = u(this, arguments), e = vc(t.event.view).on("mousemove.zoom", function () {
                    if (T_(), !n.moved) {
                ...
                }, !0), i = cc(this), o = t.event.clientX, a = t.event.clientY;
        ...
        function l() {
            if (y.apply(this, arguments)) {
                var i = this.__zoom, u = cc(this), a = i.invert(u), c = i.k * (t.event.shiftKey ? .5 : 2),
        ...
        function p() {
            ...
            if (i = c.that.__zoom, c.touch1) {
                var l = c.touch0[0], h = c.touch0[1], p = c.touch1[0], d = c.touch1[1],
        ...
        var g, _, y = ha, m = pa, x = _a, b = va, w = ga, M = [0, 1 / 0], T = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
            N = 250, k = Ms, S = [], E = a("start", "zoom", "end"), A = 500, z = 150, P = 0;
        return n.transform = function (t, n) {
            ...
            n.transform(t, function () {
                var t = m.apply(this, arguments), n = this.__zoom, u = i(t), a = n.invert(u),
            ...
            n.transform(t, function () {
                var t = m.apply(this, arguments), n = this.__zoom, o = i(t);
